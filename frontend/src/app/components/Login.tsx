...
export function Login({ onLogin }: LoginProps) {
  ...
  const handleSocialLogin = (provider: 'google' | 'kakao') => {
    ...
    // 리다이렉트 전 짧게라도 피드백을 보여준 뒤 이동
    setTimeout(() => {
      if (provider === 'google') startGoogleLogin()
        ...
        <div className="px-6 pt-16 pb-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 rounded-xl py-3.5 hover:bg-gray-50 transition-colors shadow-sm disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={socialLoading !== null}
              className="w-full flex items-center justify-center gap-3 bg-[#FEE500] rounded-xl py-3.5 hover:bg-[#F5DC00] transition-colors disabled:opacity-50"
            >
              {socialLoading === 'kakao' ? (
